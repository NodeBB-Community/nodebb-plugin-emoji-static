...
Instance.prototype.updateFlow = function () {
  ...
  return Q
      ...
      .then(function (resolved) {
            if (resolved === targetPath) { return Q.reject("Target already exists."); }
            return Q.nfcall(fs.unlink, self.assetsPath);
          },
          function () { wrench.mkdirSyncRecursive(path.dirname(self.assetsPath)); })
      .then(function () { return Q.nfcall(fs.symlink, targetPath, self.assetsPath, "dir"); }, _.noop)
